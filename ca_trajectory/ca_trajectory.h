/** @file
 *  @brief MAVLink comm protocol generated from ca_trajectory.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_CA_TRAJECTORY_H
#define MAVLINK_CA_TRAJECTORY_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_CA_TRAJECTORY.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
